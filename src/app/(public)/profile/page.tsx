          ...
          <div className="w-full lg:w-80 flex flex-col gap-6">
            <div className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-xl shadow-gray-100/50 flex flex-col items-center text-center">
              ...
              <div className="w-full space-y-2">
                <button className="w-full flex items-center gap-3 px-6 py-3 bg-black text-white rounded-xl text-xs font-black uppercase tracking-widest transition-all">
                  <User className="w-4 h-4" />
                  Thông tin cá nhân
                </button>
                <button className="w-full flex items-center gap-3 px-6 py-3 text-gray-400 hover:text-black hover:bg-gray-50 rounded-xl text-xs font-black uppercase tracking-widest transition-all">
