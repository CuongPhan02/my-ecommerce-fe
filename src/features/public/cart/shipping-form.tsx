  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-2xl border border-blue-100 mb-2">
        <div className="pt-1"><input type="checkbox" defaultChecked className="w-4 h-4 accent-black cursor-pointer" /></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col gap-2">
          ...
          <input 
            ...
            className={cn(
              ...
              errors.shippingName ? "border-red-500 focus:border-red-500" : "border-gray-200"
            )}
          />
          {errors.shippingName && <p className="text-red-500 text-[10px] font-bold uppercase tracking-wider">{errors.shippingName}</p>}
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <input 
            ...
            className={cn(
              "w-full py-3.5 px-6 border rounded-2xl text-sm font-bold placeholder:font-medium placeholder:text-gray-300 focus:border-black focus:outline-none transition-all bg-white",
              errors.shippingPhone ? "border-red-500 focus:border-red-500" : "border-gray-200"
            )}
          />
          {errors.shippingPhone && <p className="text-red-500 text-[10px] font-bold uppercase tracking-wider">{errors.shippingPhone}</p>}
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <input 
          ...
          className={cn(
            "w-full py-3.5 px-6 border rounded-2xl text-sm font-bold placeholder:font-medium placeholder:text-gray-300 focus:border-black focus:outline-none transition-all bg-white",
            errors.shippingEmail ? "border-red-500 focus:border-red-500" : "border-gray-200"
          )}
        />
        {errors.shippingEmail && <p className="text-red-500 text-[10px] font-bold uppercase tracking-wider">{errors.shippingEmail}</p>}
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <input 
          ...
          className={cn(
            "w-full py-3.5 px-6 border rounded-2xl text-sm font-bold placeholder:font-medium placeholder:text-gray-300 focus:border-black focus:outline-none transition-all bg-white",
            errors.street ? "border-red-500 focus:border-red-500" : "border-gray-200"
          )}
        />
        {errors.street && <p className="text-red-500 text-[10px] font-bold uppercase tracking-wider">{errors.street}</p>}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col gap-2">
          ...
          <input 
            ...
            className={cn(
              "w-full py-3.5 px-6 border rounded-2xl text-sm font-bold placeholder:font-medium placeholder:text-gray-300 focus:border-black focus:outline-none transition-all bg-white",
              errors.province ? "border-red-500 focus:border-red-500" : "border-gray-200"
            )}
          />
          {errors.province && <p className="text-red-500 text-[10px] font-bold uppercase tracking-wider">{errors.province}</p>}
        </div>
        <div className="flex flex-col gap-2">
          ...
          <input 
            ...
            className={cn(
              "w-full py-3.5 px-6 border rounded-2xl text-sm font-bold placeholder:font-medium placeholder:text-gray-300 focus:border-black focus:outline-none transition-all bg-white",
              errors.city ? "border-red-500 focus:border-red-500" : "border-gray-200"
            )}
          />
          {errors.city && <p className="text-red-500 text-[10px] font-bold uppercase tracking-wider">{errors.city}</p>}
        </div>
      </div>
