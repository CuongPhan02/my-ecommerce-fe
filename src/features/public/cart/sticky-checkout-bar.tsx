    ...
    <div className='fixed bottom-0 left-0 right-0 bg-blue-50 border-t border-blue-100 z-50 shadow-[0_-10px_40px_rgba(0,0,0,0.05)]'>
      <div className='main-container mx-auto px-4 h-24 flex items-center justify-between'>
        ...
        <div className='flex-1 flex flex-col items-center lg:items-end lg:pr-12'>
          ...
          <div className='flex items-center gap-3 mt-1'>
            <p className='text-[10px] font-bold text-gray-500 uppercase tracking-widest'>
              <span className='text-black font-black'>CoolClub</span> tích lũy hoàn tiền cho đơn hàng này.
            </p>
          </div>
        </div>
        ...
        <button 
          ...
          className={cn(
            'h-full bg-black flex items-center px-12 group cursor-pointer hover:bg-primary transition-all disabled:opacity-50 disabled:cursor-not-allowed border-none outline-none',
            isSubmitting && 'bg-primary'
          )}
        >
          <span className='text-white font-black text-sm uppercase tracking-[0.3em] flex items-center gap-3 select-none'>
            {isSubmitting ? (
              <>
