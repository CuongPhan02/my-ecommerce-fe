      ...
      <div className="main-container mx-auto px-4 h-24 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-12">
           ...
           <div className="flex items-center gap-4 text-gray-700">
             ...
             <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Ưu đãi</p>
                <p className="text-sm font-black text-blue-600 italic">Chọn Voucher</p>
             </div>
           </div>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center lg:items-end lg:pr-12">
           <div className="flex items-center gap-2">
              ...
              <button className="text-blue-300 hover:text-blue-600 transition-colors"><Info className="w-4 h-4" /></button>
           </div>
           <div className="flex items-center gap-3 mt-1">
              <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">
                 <button className="text-blue-600 hover:underline mr-1">Đăng nhập</button>
                 để hoàn <span className="text-black font-black">9.000 CoolCash</span>
              </p>
              <span className="text-[10px] text-gray-300 font-bold uppercase tracking-widest border-l pl-3">Tiết kiệm 0đ</span>
           </div>
        </div>
